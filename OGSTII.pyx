...
str p_suffix):
    ...
    cdef:
        ...
        cnp.ndarray[cnp.float32_t, ndim=1] e2c, e3c, ewe, G2c, G3c, Gwe, pfm_c2, pfm_c3, pfm_we, c2, c3, we, twe
        cnp.ndarray[cnp.int32_t, ndim=2] tg_edg
        cnp.ndarray[cnp.int32_t, ndim=1] G_deg, G_cudeg, G_adj, G2c1, G3c1, Gwe1, tc2, tg_cudeg, tshift, tg_adj, tc3
        ...
        cnp.int32_t[:, :] tg_edg_v
        cnp.int32_t[:] G_deg_v, G_cudeg_v, G_adj_v, Gnn1_v, Gnn2_v, n12_v, tc2_v, tg_cudeg_v, tshift_v, tg_adj_v, tc3_v, mk_v, tg_ni_v, tg_nj_v, G_ni_v
        cnp.int8_t[:] g_adj_v, mk3_v, mkG_v, gnn1p_v, gnn2p_v, L_v, L_new_v, g_ni_v
        Py_ssize_t i=0, j=0, ni=0, nj=0, n_gnn12=0, ij=0, r=0, nn=0, mk=0, mk_ni=0, mk_nj=0, u=0, v=0, ii=0, jj=0, itg=0, iG=0
